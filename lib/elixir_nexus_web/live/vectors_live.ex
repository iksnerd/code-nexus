defmodule ElixirNexus.VectorsLive.Index do
  ...
  def render(assigns) do
    ...
    <.collection_stats {assigns} />
    <.entity_type_dist_bar {assigns} />
    <.actions_bar {assigns} />
    <.filter_bar {assigns} />
    <.points_table {assigns} />
    <.pagination_controls {assigns} />
    <.detail_modal {assigns} />
    <.flash_notice {assigns} />
    """
  end
  ...
  defp collection_stats(assigns) do
    ~H"""
  ...
  defp entity_type_dist_bar(assigns) do
    ~H"""
