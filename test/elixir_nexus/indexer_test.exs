defmodule ElixirNexus.IndexerTest do
  ...
  setup do
    ...
    test_dir = Path.join(temp_dir, "index_test_#{:rand.uniform(1_000_000)}")
  ...
  describe "index_directory/1" do
    ...
    test "handles empty directory" do
      temp_dir = System.tmp_dir!()
      empty_dir = Path.join(temp_dir, "empty_#{:rand.uniform(1_000_000)}")
  ...
  describe "error resilience" do
    ...
    test "handles concurrent indexing gracefully" do
      ...
      temp_dir = System.tmp_dir!()
      test_dir = Path.join(temp_dir, "concurrent_#{:rand.uniform(1_000_000)}")
      File.mkdir_p(test_dir)
